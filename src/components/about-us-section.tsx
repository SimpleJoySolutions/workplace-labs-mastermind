        ...
        <div className="container px-4 md:px-6 mx-auto max-w-7xl">
          ...
          <div className="space-y-12">
            <FounderProfile
              ...
              role="Instructor"
              bio={[
                "Hi, I'm Neil. My passion for the intersection of technology and talent management began during my doctoral studies in Industrial-Organizational (I-O) Psychology. I had the opportunity to publish one of the first empirical research articles on the differences between mobile and non-mobile delivered employment tests.",
                ...
                "AI is a tool. In the right hands, it can be a powerful force for good in the lives of millions of workers, benefiting their employers as well. I want to help you be a part of this change and direct it to be a positive outcome for you and your organization.",
              ]}
            ...
            <FounderProfile
              ...
              bio={[
                ...
                "If you've used many AI tools recently, this illustration likely resonates. The number of failed or underwhelming AI apps is staggering. AI is unlike any other innovation, making it challenging to find the right fit between the product and our actual needs.",
